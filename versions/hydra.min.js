...
(function (a) {
  "use strict";
  var b = setTimeout, c, d = Error, e, f, g, h, i, j = {}, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A;
  f = function (a, b) {
    return typeof a === b
  }, g = function (a, b) {
  ...
  h = "undefined", A = Object.prototype, e = this, c = e, z = typeof exports === k && typeof module === k && typeof module.exports === k && typeof require === r, l = null, p = !1, o = !0, i = {}, q = "3.8.2", u = p, m = p;
  function G(a) {
  ...
  function Q(a) {
    var b, c;
    if (null == a || !f(a, k) || -1 === a.constructor.toString().indexOf("Object()") || B(a) || C(a) || a.nodeType && 1 === a.nodeType)return a;
    if (g(a, Date))return b = new Date, b.setTime(a.getTime()), b;
    if (g(a, Array))return b = L(Array, 0);
    if (g(a, Object)) {
      b = {};
      for (c in a)M(a, c) && (b[c] = Q(a[c]));
      return b
    }
  ...
  x = {subscribers: function (a, b) {
    ...
    return c > 0
  }, _executeHandler: function (a, b, c, d) {
    a.handler.call(a.subscriber, b), u && v.log(c, d, a)
  }, _avoidBlockUI: function (a, c, d, e) {
    var f = L(a, 0);
    b(function g() {
      var a = +new Date;
      do this._executeHandler(f.shift(), c, d, e); while (f.length > 0 && +new Date - a < 50);
      f.length > 0 && b(g, 25)
    }, 25)
  }, publish: function (a, b, c) {
    var d = L(this.subscribers(a, b), 0), e, f = d.length, g;
    if (0 === f)return p;
    if (g = Q(c), m)this._avoidBlockUI(d, g, a, b); else while (e = d.shift())this._executeHandler(e, g, a, b);
    return o
  }, reset: function () {
    y = {global: {}}
  }};
  ...
  v = e.console || {log: function () {
    ...
    var e, f, g, h, i, j;
    for (I(b) && (e = L(b, 0)), I(c) && (f = L(c, 0)), I(d) && (g = L(d, 0)), h = 0, i = a.length; i > h; h++)j = a[h], b = e && e[h] || E(), c = f && f[h] || c, d = g && g[h] || d, O(this, j, b, c, d)
  }, _singleModuleStart: function (a, b, c, d) {
    f(b, "string") || (d = c, c = b, b = E()), O(this, a, b, c, d)
  }, start: function (a, b, c, d) {
    var e = I(a);
    e ? this._multiModuleStart(L(a, 0), b, c, d) : this._singleModuleStart(a, b, c, d)
    ...
    return e ? (h = V(a), f(b, r) && (d = b, b = a, c = [x, t.module, t.errorHandler(), t]), f(c, r) && (d = c, c = [x, t.module, t.errorHandler(), t]), c.push(h), g = d.apply(d, c), i[b] = new s(b, function () {
      var a = {};
      return a = P(a, h), a = P(a, g), a = P(a, {__super__: {__call__: function (b, c) {
        return h[b].apply(a, c)
      }}})
